...
if pagina_seleccionada == 'Inicio':
    ...
    if grafico_seleccionado == 'Gráfico de barras':
        ...
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Esta nube de palabras muestra las palabras que más se repiten en un texto. Las más grandes son las más frecuentes. Representa los temas principales y el vocabulario dominante del contenido analizado.</div>", unsafe_allow_html=True)
