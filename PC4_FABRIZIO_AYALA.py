...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center; color: blue;'>Blog FABRIZIO AYALA</h1>", unsafe_allow_html=True)
    ...
    col1.image("FT.jpg", caption='Fabrizio', width=300)
    ...
    texto = """
    Que tal, Mi nombre es Fabrizio Ayala. Tengo 19 años. Actualmente estudio la carrera de Periodismo en la Pontificia Universidad Católica del Perú.
    En parte escogí mi carrera porque me gusta el futbol y mucha gente me decia que podria ser locutor por mi voz.
    Pero fuera de lo académico, me gusta dibujar y escuchar música.
    """
    ...
    # Agregamos un título
    st.markdown("<h1 style='text-align: center; color: blue'>Mi experiencia aprendiendo a programar 💻</h1>", unsafe_allow_html=True)
    ...
    texto_2 = """
     Al principio me sentía confundido y un poco frustrado, porque todo era nuevo con python. 
     Con el tiempo, la programación me ha enseñado a pensar de forma lógica y a ser más paciente.
     Lo que más me gusta es crear cosas desde cero y ver cómo el código funciona. En el futuro, me gustaría 
     hacer proyectos más grandes, como apps o pequeños programas útiles usando Python.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>VIDEO FOR Y WHILE 🎥</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/13ny-DQVBCgMN62DTXXXzEf-S9Bp530Yr/view?usp=sharing' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center; color: blue'>Mis primeros gráficos 📊</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Gráfico de barras', 'Nube de palabras', 'Gráfico de pastel', 'Mapa de películas']
    ...
    if grafico_seleccionado == 'Gráfico de barras':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El gráfico muestra que el Barcelona, cuando juega como visitante, suele anotar principalmente 2 y 4 goles, ya que estos valores aparecen con mayor frecuencia en los partidos analizados. En cambio, los resultados con 0 o 1 gol son mucho menos comunes, lo que indica que el equipo rara vez se queda sin producir ofensivamente fuera de casa. En general, el comportamiento observado refleja que el Barcelona mantiene un nivel goleador bastante alto como visitante, demostrando capacidad para generar ocasiones y convertirlas incluso lejos de su estadio.</div>", unsafe_allow_html=True)
        st.image("código de barras.png", caption='Gráfico de Barras', width=500)
        pass
    elif grafico_seleccionado == 'Nube de palabras':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Esta nube de palabras muestra los términos que más se repiten en un texto, destacando visualmente cuáles son las ideas principales del contenido analizado. Las palabras que aparecen en mayor tamaño son las más frecuentes, lo que permite identificar rápidamente los conceptos más relevantes y el vocabulario dominante. Esta representación facilita comprender de manera general el tema del texto, ya que resume visualmente los elementos más mencionados sin necesidad de revisar línea por línea, ofreciendo una visión clara y sintetizada del enfoque del contenido.</div>", unsafe_allow_html=True)
        st.image("nube de palabras.png", caption='Nube de palabras', width=500)
        pass
    elif grafico_seleccionado == 'Gráfico de pastel':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>EEl gráfico muestra que, cuando el Real Madrid juega como local, logra un dominio muy claro en sus resultados, ya que gana la gran mayoría de sus partidos (84.2%), mientras que solo pierde un porcentaje reducido (10.5%) y empata aún menos (5.3%). Esta distribución evidencia que el equipo mantiene un rendimiento excepcional en casa, aprovechando su localía para imponer su juego y asegurar la mayoría de puntos. En conjunto, estos datos reflejan una superioridad constante y una gran solidez futbolística cada vez que el equipo juega en su estadio.</div>", unsafe_allow_html=True)
        st.image("Grafico pastel.png", caption='Gráfico de pastel', width=500)
        pass
    elif grafico_seleccionado == 'Mapa de películas':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Este mapa muestra las ubicaciones geográficas relacionadas con distintas películas, ya sea porque fueron filmadas allí o porque su historia se desarrolla en esos lugares. Cada marcador representa una película específica e incluye información como el título, el director, el año y el país, lo que permite visualizar de manera clara cómo estas producciones se distribuyen alrededor del mundo. En conjunto, el mapa ofrece una representación visual que facilita identificar la diversidad de escenarios cinematográficos y entender la relación entre cada película y su localización.</div>", unsafe_allow_html=True)
